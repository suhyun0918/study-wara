...
public class NotificationController {
    ...
    private void putCategorizedNotifications(final Model model, final List<Notification> notifications,
                                             final long numberOfChecked, final long numberOfNotChecked) {
        ...
        for (var notification : notifications) {
            ...
            if (notificationType == NotificationType.STUDY_CREATED) {
                newStudyNotifications.add(notification);
            } else if (notificationType == NotificationType.EVENT_ENROLLMENT) {
                eventEnrollmentNotifications.add(notification);
            } else if (notificationType == NotificationType.STUDY_UPDATED) {
